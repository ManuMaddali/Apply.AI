...
/**
 * GlobalEnhancementSettings Component
 * Subtask 4.1: Enhancement level selector and auto-include section toggles
 */
function GlobalEnhancementSettings({
  settings,
  onSettingsChange,
  isProUser,
  onUpgradeClick,
  ...
  const enhancementLevels = [
    {
      id: 'conservative',
      name: 'Conservative',
      description: 'Light keyword optimization, preserve original structure',
      impact: '+8-12 points',
      features: [
    ...
    },
    {
      id: 'balanced',
      name: 'Balanced',
      description: 'Moderate enhancement with metrics and stronger language',
      impact: '+15-20 points',
      features: [
    ...
    },
    {
      id: 'aggressive',
      name: 'Aggressive',
      description: 'Heavy rewriting with maximum keyword optimization',
      impact: '+22-27 points',
      features: [
  ...
  // Auto-include sections configuration
  const autoIncludeSections = [
    {
      id: 'summary',
      name: 'Professional Summary',
      description: 'Add or enhance professional summary section',
      impact: '+5-8 points',
      essential: true,
      proOnly: false
    },
    {
      id: 'skills',
      name: 'Skills Section',
      description: 'Extract and organize relevant skills',
      impact: '+8-12 points',
      essential: true,
      proOnly: false
    },
    {
      ...
      description: 'Optimize education section formatting',
      impact: '+2-4 points',
      essential: false,
      proOnly: false
    },
    ...
    },
    {
      ...
      description: 'Highlight key achievements and awards',
      impact: '+4-6 points',
      essential: false,
      proOnly: true
    },
    {
      id: 'certifications',
      name: 'Certifications',
      description: 'Organize and highlight certifications',
      impact: '+3-5 points',
      essential: false,
      proOnly: true
    }
  ...
  const handleSectionToggle = useCallback((sectionId) => {
    ...
    setLocalSettings(newSettings);
    onSettingsChange(newSettings);
  }, [localSettings, onSettingsChange, isProUser, onUpgradeClick, autoIncludeSections]);

  const getSelectedLevel = () => enhancementLevels.find(level => level.id === localSettings.enhancementLevel);
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <EnhancedCardDescription>
                  Choose how extensively to enhance your resume
                </EnhancedCardDescription>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-500">Estimated Impact</div>
                <div className="text-lg font-bold text-green-600">+{getTotalImpact()} points</div>
              </div>
            </div>
          </EnhancedCardHeader>
          <EnhancedCardContent>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm font-medium text-green-600">{level.impact}</div>
                      </div>
          ...
          <EnhancedCardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <EnhancedCardDescription>
                  Select sections to automatically enhance or add
                </EnhancedCardDescription>
              </div>
              <Button
                variant="ghost"
          ...
          <EnhancedCardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {autoIncludeSections.map((section) => {
                ...
                const showSection = section.essential || showAdvanced;
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-xs font-medium text-green-600">{section.impact}</span>
                        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-600">
                <span>Level: <strong>{selectedLevel?.name}</strong></span>
                <span>•</span>
                <span>Sections: <strong>{Object.values(localSettings.autoIncludeSections).filter(Boolean).length}</strong></span>
                <span>•</span>
                <span>Impact: <strong>+{getTotalImpact()} points</strong></span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <TrendingUp className="w-5 h-5 text-green-500" />
              <span className="text-lg font-bold text-green-600">Optimized</span>
            </div>
          </div>
        </div>
      </motion.div>
